"""Differentiable-sim infrastructure — Taichi ``ti.ad.Tape`` backend (plan § 4.2.A).

Public surface (identical to :mod:`common_warp.autodiff`, the Warp backend):
...
First-of-pattern for ``ti.ad.Tape`` in this repo (Phase 3 PINN used PyTorch
