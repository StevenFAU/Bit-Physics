"""Make the hyphenated ``binary-release/`` tool dir importable for the smoke suite.

The Phase-5 tool tree is ``tools/productization/<sub-phase-name>/`` with
hyphenated names (§ 5.1 / § 4.14 of the phase plan; ``git grep binary-release``
...
Mirrors ``tools/productization/pypi-release/smoke/conftest.py``.
"""
