...
| 23 | 4.15 | volumetric-grid/eulerian-smoke | frontier-clebsch-pfm | C | — | (none) | — | docs/sim-specs/volumetric-grid/eulerian-smoke/spec-frontier-clebsch-pfm.md | 2 (wave_function_normalized + velocity_reconstruction_divergence_bounded) | yes | c1-u4-landing (phase-6) | **landed** (Phase-6 C-1 U-4, FIRST particle-flow-map substrate + first Stack-C volumetric-grid; deferral history: P4-Greenfield-CPU, greenfield-needs-base-sim) |
| 24 | 4.16 | volumetric-grid/eulerian-smoke | frontier-edge | C | — | (none) | — | docs/sim-specs/volumetric-grid/eulerian-smoke/spec-frontier-edge.md | 2 (reconstructed_velocity_divergence_free + backward_map_memory_constant) | yes | c1-u6-landing (phase-6) | **landed** (Phase-6 C-1 U-6, THIRD + final flow-map-family member; GRID backward flow maps per DOI 10.1145/3731193 **EDGE proper / incompressible** [D-1 conflation closed — NOT the compressible-flowmap paper …3731192, correcting the stale "EDGE compressible flow-map" record]; INDEPENDENT of the U-4/U-5 particle substrate; O(1)-memory 240 MiB CONSTANT-in-L MEASURED; dt=0.00125 CFL-safe SHIFT; ε-difference item-2 DEFERRED-with-cause; deferral history: P4-Greenfield-CPU, greenfield-needs-base-sim) |
| 25 | 4.17 | volumetric-grid/eulerian-smoke | frontier-vpfm | C | — | (none) | — | docs/sim-specs/volumetric-grid/eulerian-smoke/spec-frontier-vpfm.md | 2 (reconstructed_velocity_divergence_free + total_circulation_bounded) | yes | c1-u5-landing (phase-6) | **landed** (Phase-6 C-1 U-5, SECOND particle-flow-map; reuses the U-4 substrate; dt=0.00125 CFL-safe SHIFT; deferral history: P4-Greenfield-CPU, greenfield-needs-base-sim) |
...
| 28 | 4.20 | continuous-ca/neural-ca | frontier-difflogic-ca | D | § 4.2.A | (none) | — | docs/sim-specs/continuous-ca/neural-ca/spec-frontier.md | 2 (hard_limit_matches_truth_table + gradient_matches_finite_difference) | yes | c1-u2-landing (phase-6) | **landed** (Phase-6 C-1 U-2, D-3 frozen-gate scope; deferral history: P4-Greenfield-CPU, batch-3 HELD) |
| 29 | 4.21 | lattice/lattice-boltzmann-d3q19 | frontier-moment-encoded | C | § 4.2.B (vestigial — measured no sparse consumption) | (none) | — | docs/sim-specs/lattice/lattice-boltzmann-d3q19/spec-frontier.md | 2 (mass_moment_conserved + momentum_moment_conserved) | yes | c1-u3-landing (phase-6) | **landed** (Phase-6 C-1 U-3, first Stack-C LBM; D-2 lbm-quantized; deferral history: P4-Greenfield-CPU, batch-3 HELD — A-2 ratified batch-3's rigorous-anchors-exist reading) |
