...
export const SCENES: SceneSpec[] = [
  {
    ...
    displayOmega: OM_DEF,
    substeps: 10,
    layers: LAYER.field | LAYER.underlay | LAYER.sources,
    exposure: 1,
    fieldGain: 1.6,
    ampGain: 2.2,
    isoK: 14,
  ...
  },
  {
    ...
    displayOmega: OM_DEF,
    substeps: 10,
    layers: LAYER.field | LAYER.underlay | LAYER.schlieren | LAYER.sources,
    exposure: 1,
    fieldGain: 2.2,
    ampGain: 3,
    isoK: 12,
  ...
  },
  {
    ...
    displayOmega: OM_DEF,
    substeps: 12,
    layers: LAYER.field | LAYER.sources,
    exposure: 1,
    fieldGain: 1.5,
    ampGain: 2.4,
    isoK: 12,
  ...
  },
  {
    ...
    substeps: 12,
    layers: LAYER.field | LAYER.underlay | LAYER.envelope | LAYER.sources,
    exposure: 1,
    fieldGain: 2.2,
    ampGain: 3,
    isoK: 12,
